...
<head>
    ...
    <link rel="stylesheet" href="../../../../../group_project_1.0/app/views/NavBar/Guest_NavBar/NavBar.css">
</head>
<body>
<div class="navbar">
...
<div class="nav-overlay" id="navOverlay">
    ...
    <br>
    <div class="auth-buttons">
        <a href="Signup" class="signup-btn"  ><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/singup.png">Sign Up</a>
        <a href="Signin" class="login-btn" ><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/singup.png">Login</a>
    </div>
</div>
...
<script src=".../../../../../group_project_1.0/app/views/NavBar/Guest_NavBar/NavBar.js"></script>
</body>
</html>
