...
<div class="profile-overlay" id="profileOverlay">
    ...
    <div class="profile-links">
        ...
        <a href="Blog"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/blogs.png">My Blogs</a>
        <a href="#"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/subscription.png">Subscriptions</a>

    </div>
    <br>    <br>    <br><br>
        <br><br>
    <div class="auth-buttons">
        <a href="#" onclick="Logout()"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/logout.png">Log out</a>
    </div>
</div>
...
<div class="nav-overlay" id="navOverlay">
    ...
    <div class="nav-links">
        ...
        <a href="#"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/school.png">classes</a>
        <a href="#"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar /icon/ads.png">Advertisements</a>
        <a href="#"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/blogs.png">Blogs</a>
        ...
        <a href="#"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/blogs.png">My Blogs</a>
        <a href="#"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/subscription.png">Subscriptions</a>
    </div>
    <div class="auth-buttons">
        <a href="#" onclick="Logout()"><img src="../../../../../group_project_1.0/app/views/NavBar/User_NavBar/icon/logout.png">Log out</a>
