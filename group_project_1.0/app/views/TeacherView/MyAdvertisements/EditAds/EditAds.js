// Show the popup form
  ...
  function UpdateAdds() {
    ...
    windows.alert("D o you want to Update Adds");
    ...
    if (title && description && adsid && imageURL) {
...
function deleteAdds(adsid) {
  ...
  if (confirmDelete) {
    ...
    fetch('./deleteBlog.php', {
      ...
      body: JSON.stringify({ id: adsid }), // Send the blog ID in the body as JSON
    })
